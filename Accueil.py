...
services = [
        {"name": "Stock Picking", "description": "Optimize your stock selections with our advanced analytics.", "icon": "📈"},
        {"name": "Portfolio Visualizer", "description": "Visualize your investment spread and analyze performance metrics.", "icon": "📊"},
        {"name": "Portfolio Optimizer", "description": "Maximize your portfolio's performance based on modern financial.", "icon": "⚙️"},
        {"name": "Forecasting", "description": "Competitive pricing strategies tailored for different investment levels.", "icon": "💰"}
    ]
